// app/programs/us/discovery-flight/page.tsx
import Link from "next/link";
import AppShell from "../../../../components/ui/AppShell";
import styles from "./discoveryFlight.module.css";

const highlights = [
  { title: "Preflight briefing", text: "Meet your instructor, review the plan, and learn the basics before you fly." },
  { title: "Hands-on flying", text: "You’ll take the controls (with instructor guidance) and experience real flight." },
  { title: "Photo-ready moment", text: "Bring a friend to take photos (depending on aircraft policy and safety)." },
  { title: "Next-step roadmap", text: "After landing, we’ll walk you through training options and a realistic plan." },
];
...
const faqs = [
  { q: "Do I need experience to do a Discovery Flight?", a: "No — it’s designed for beginners. Your instructor will handle everything step-by-step." },
  { q: "What should I wear?", a: "Comfortable clothes and closed-toe shoes. Sunglasses are recommended on sunny days." },
  { q: "Can I bring someone with me?", a: "Often yes, but it depends on aircraft seating and safety policy. Ask admissions when booking." },
  { q: "Is it a good gift?", a: "Yes — a Discovery Flight is one of the best introductions to aviation and makes a great gift." },
];
            ...
            <div className={styles.heroGrid}>
              <div>
                ...
                <div className={styles.heroCtas}>
                  ...
                  <Link className={`${styles.btn} ${styles.btnGhost}`} href="/programs/us">
                    Back to programs
                  </Link>
                </div>
          ...
          <div className={styles.container}>
            <div className={styles.twoCol}>
              ...
              <div className={styles.panel}>
                ...
                <p className={styles.muted}>Keep it simple. We recommend:</p>
          ...
          <div className={styles.container}>
            <div className={styles.ctaInner}>
              ...
              <div className={styles.ctaButtons}>
                ...
                <Link className={`${styles.btn} ${styles.btnSecondary}`} href="/programs/us">
                  Explore programs
                </Link>
              </div>
            </div>
